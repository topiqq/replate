    ...
    <div style={{ minHeight: "100vh", background: C.cream }}>
      ...
      >
        <div style={{ maxWidth: 800 }}>
          ...
          >
            Terhubung dengan restoran dan kafe terbaik yang berkomitmen
            mengurangi limbah makanan. Nikmati hidangan lezat sambil
            berkontribusi untuk planet yang lebih sehat.
          </p>
          ...
          >
            {[
              ...
              >
                ...
                <p
                  style={{ fontSize: 14, color: C.textMuted, lineHeight: 1.6 }}
                >
                  {feature.desc}
                </p>
              </div>
      ...
      >
        <div style={{ maxWidth: 600, margin: "0 auto" }}>
          ...
          >
            Jadilah bagian dari gerakan keberlanjutan. Daftar hari ini dan mulai
            menikmati makanan lezat sambil menyelamatkan planet.
          </p>
          <button
            onClick={onGetStarted}
            style={{
      ...
      >
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          >
            © 2024 Re-Plate. Semua hak dilindungi. Bersama menjaga planet lebih
            hijau.
          </div>
        </div>
      </footer>
